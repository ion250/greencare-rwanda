...
export default function Order() {
  ...
  const generateWhatsAppMessage = () => {
    const message = `Hello GreenCare Rwanda,%0A%0AI would like to order Grekompost:%0A%0AName: ${formData.name}%0AEmail: ${formData.email}%0APhone: ${formData.phone}%0AQuantity: ${formData.quantity} ${formData.unit}%0ADelivery Address: ${formData.deliveryAddress}%0ADelivery Date: ${formData.deliveryDate}%0ASpecial Instructions: ${formData.specialInstructions}%0A%0AThank you!`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative z-10 pt-16">
        ...
        <section className="bg-white bg-opacity-90 py-24">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold text-green-800 mb-4">Order Grekompost</h1>
            <p className="text-xl text-gray-700 mb-8">Premium organic compost for your home garden or farm</p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-white bg-opacity-90 p-8 rounded-lg shadow-lg">
              <div className="flex items-center mb-6">
                <img 
                  src="https://images.unsplash.com/photo-1605454566722-6a2888e0883e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" 
                  alt="Grekompost"
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <input
                        ...
                        onChange={handleChange}
                        className="w-2/3 px-4 py-2 border border-gray-300 rounded-l-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                      />
                      <select
                        name="unit"
                        value={formData.unit}
